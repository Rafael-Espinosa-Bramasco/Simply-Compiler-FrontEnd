 ...
 * @author rafael
 */
public class ASMCODE extends javax.swing.JFrame {

    /**
     * Creates new form ASMCODE
     */
    public ASMCODE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Assembly Code");
        setResizable(false);

        codeField.setEditable(false);
        codeField.setColumns(20);
        codeField.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        codeField.setRows(5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ASMCODE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
